...
const COMMANDS: Array<{ test: (text: string) => boolean; handle: Handler }> = [
  {
    ...
    handle: async () =>
      [
        "ฉันช่วยได้ 6 เรื่อง — พิมพ์คำสั่งด้านล่าง หรือแตะเมนูใต้ช่องพิมพ์ก็ได้:",
        "",
        "💰 จดเงิน",
        ...
        "• ถาม ข่าวหุ้น (หรือถามเรื่องบิตคอยน์/ทอง/การเงินสหรัฐ) สรุปข่าวการเงิน พร้อมราคาทอง/บิตคอยน์/ดัชนี S&P 500 และหุ้นสหรัฐที่ขึ้น-ลงแรงสุดให้",
        ...
        "",
        "🌐 ดูข้อมูลผ่านเว็บ",
        "• เปิดเว็บดูข้อมูล — ขอลิงก์ดูสรุปบัญชีผ่านเว็บ (เห็นเฉพาะคุณคนเดียว ลิงก์ใช้ได้ 1 ชั่วโมง)",
      ].join("\n"),
  },
  {
