...
export function buildCapabilityText(): string {
  return [
    ...
    "🧾 ถ่ายรูปใบเสร็จ/สลิป/บัตรนัด ส่งมาแล้วจดให้เลย",
    "🗓️ ตารางเวร",
...
export function buildHelpText(webSearchEnabled: boolean): string {
  const sections = [
    ...
    "",
    "🧾 ถ่ายรูปแล้วให้บอทจดให้",
    "• ส่งรูปตอนที่**ไม่ได้เปิดทริป** บอทจะดูว่าเป็นอะไรแล้วเสนอให้บันทึก ยืนยันด้วย \"ใช่\" เหมือนพิมพ์เอง",
    "• ใบเสร็จ/บิล/สลิปจ่ายเงิน → เสนอเป็นรายจ่าย",
    "• สลิปเงินเข้า/สลิปเงินเดือน → เสนอเป็นรายรับ (สลิปโอนธรรมดาที่ดูไม่ออกว่าเข้าหรือออก จะเสนอเป็นรายจ่ายไว้ก่อน)",
    "• บัตรนัด/ใบนัดหมอที่มีวันและเวลา → เสนอสร้างนัดในปฏิทิน (แปลง พ.ศ. เป็น ค.ศ. ให้เอง)",
    "• บอทจะบอกก่อนว่าอ่านได้อะไร ถ้าอ่านผิดจะเห็นทันที แล้วกด ไม่ใช่ ได้เลย",
    "• ระหว่างเปิดทริปอยู่ รูปทุกใบจะเข้าอัลบั้มทริปเหมือนเดิม ไม่ถูกอ่าน",
    "",
    "🎤 ข้อความเสียง",
