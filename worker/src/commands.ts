...
const COMMANDS: Array<{ test: (text: string) => boolean; handle: Handler }> = [
  {
    ...
    handle: async () =>
      [
        ...
        "• พิมพ์รายการตรงๆ เช่น \"ซื้อกาแฟ 60\" หรือ \"เงินเดือนเข้า 25000\"",
        "• สรุปวันนี้ / สรุปสัปดาห์นี้ / สรุปเดือนนี้ / สรุปเดือนที่แล้ว",
        "• เหลือเงินเท่าไหร่ / รายรับเดือนนี้เท่าไหร่ / รายจ่ายเดือนนี้เท่าไหร่",
        "• วันไหนใช้เงินเยอะที่สุด / หมวดไหนใช้เงินเยอะที่สุด / ซื้ออะไรบ่อยที่สุด",
        "• เฉลี่ยใช้เงินต่อวันเท่าไหร่ / งบเหลือเท่าไหร่",
        "• ค้นหา <คำ> เช่น \"ค้นหากาแฟ\" / รายการล่าสุด",
        "• เริ่มทริป <ชื่อ> แล้วส่งรูปเข้ามาได้เลย เก็บขึ้น Google Drive ให้อัตโนมัติ / จบทริป / ทริปตอนนี้",
        "• นัด <เรื่อง> <วันที่> <เวลา> เช่น \"นัด ประชุมทีม 12/1/2569 13:00\" / มีนัดอะไรวันนี้ (หรือพรุ่งนี้/สัปดาห์นี้) / ลบนัด <คำ> / แก้นัด <คำ> เป็น <วันเวลาใหม่>",
        "• ไดอารี่ <ข้อความ> เช่น \"ไดอารี่ #งาน วันนี้ประชุมเสร็จเร็ว\" / ไดอารี่เดือนนี้มีอะไรบ้าง / ค้นหาไดอารี่ <คำ>",
      ].join("\n"),
  },
  {
