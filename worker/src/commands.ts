...
export function buildHelpText(): string {
  const sections = [
    ...
    "• ไดอารี่เดือนนี้มีอะไรบ้าง (สรุปแยกหมวด+วันที่) / ไดอารี่วันที่ <วันที่> (รายละเอียดวันนั้น) / ค้นหาไดอารี่ <คำ> — ยังไม่มีคำสั่งแก้/ลบนะ",
    "",
    "🗓️ ตารางเวร",
    ...
    "• เปิดเว็บดูข้อมูล — ขอลิงก์ดูบัญชี/ปฏิทิน/ไดอารี่/รูปทริป/ตารางเวรผ่านเว็บ ในหน้าเดียว (ลิงก์ใช้ได้ 1 ชั่วโมง หมดอายุแล้วพิมพ์คำสั่งนี้ใหม่ได้เลย) — กลุ่มขอลิงก์ของสมุดกลุ่มเองได้เหมือนกัน",
  ];
