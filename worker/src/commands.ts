...
export function buildHelpText(webSearchEnabled: boolean): string {
  const sections = [
    ...
    "• ลงเลขผิด? เปิดเว็บดูข้อมูล แล้วแตะแก้ตัวเลข/หมวด/วันที่ของรายการไหนก็ได้ในเดือนนี้ (ลบก็ได้ ถามยืนยันก่อน) — ในแชทลบได้เฉพาะรายการล่าสุด",
    "",
    ...
    "• ไม่ต้องทักก็ได้ — 7 โมงเช้าทุกวันได้บทสรุปอัตโนมัติ (วันที่/อากาศ/ข่าว/ราคาทอง-บิตคอยน์/นัดวันนี้/เวรวันนี้/บิลที่ครบกำหนดวันนี้/วิเคราะห์ไดอารี่เมื่อวาน) เฉพาะแชทส่วนตัว ไม่ส่งเข้ากลุ่ม",
