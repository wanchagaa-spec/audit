  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["TMDB (The Movie Database)", "คำค้นหนัง/ซีรีส์ที่คุณพิมพ์ เฉพาะตอนค้นหา ไม่มีการส่งตัวตนหรือข้อมูลอื่นของคุณไปด้วย"],
...
const TERMS_SECTIONS: Section[] = [
  {
    ...
    bullets: [
      ...
      "ค้นหาหนังและซีรีส์จาก TMDB — ที่กำลังฉาย ที่กำลังจะมา ที่มาแรง ที่อยู่ในแอปสตรีมมิ่ง ค้นจากชื่อหรือจากเนื้อเรื่อง พร้อมบอกว่าดูได้ที่แอปไหนในไทย",
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["TMDB (The Movie Database)", "The movie or series search terms you type, only when searching. Nothing identifying you is sent with them."],
...
const TERMS_SECTIONS_EN: Section[] = [
  {
    ...
    bullets: [
      ...
      "Searches movies and series on TMDB — in cinemas, coming soon, trending, or new on streaming — by title or by what they are about, and shows which apps carry them in Thailand",
