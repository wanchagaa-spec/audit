...
<form method="post" action="${action}">
  ...
  <div class="card">
    ...
    <small class="field-note">วันที่ อากาศ ข่าว ราคาทอง-บิตคอยน์ นัดวันนี้ เวรวันนี้ บิลที่ครบกำหนดวันนี้ และสรุปไดอารี่เมื่อวาน · ปิดไว้ก็ยังทัก "สวัสดี" เพื่อขอสรุปเองได้ทุกเมื่อ</small>
  </div>
  <div class="card">
